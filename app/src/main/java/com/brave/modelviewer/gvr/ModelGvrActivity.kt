package com.brave.modelviewer.gvr
...
import com.brave.modelviewer.ModelViewerApplication
import com.brave.modelviewer.databinding.ActivityGvrBinding
import com.brave.modelviewer.util.Util.checkGLError
    ...
    override fun onDrawEye(eye: Eye) {
        ...
        if (model != null) {
            for (i in model.indices) {
                model[i].draw(finalViewMatrix, perspective, light)
            }
        }*/
