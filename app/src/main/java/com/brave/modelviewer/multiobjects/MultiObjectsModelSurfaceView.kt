...
import com.brave.modelviewer.util.Util.pxToDp
...
*/
class MultiObjectsModelSurfaceView(context: Context, model: List<Model>?) : GLSurfaceView(context) {
    private val renderer: MultiObjectModelRenderer
    ...
    init {
        ...
        renderer = MultiObjectModelRenderer(model)
